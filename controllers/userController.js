...
exports.createUser = async (req, res) => {
  try {
    ...
    await userActivityController.logActivity(req.user.userId,req.user.userEmail, 'create', `User created with email ${email}`);
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    await userActivityController.logActivity(req.user.userId,req.user.userEmail, 'delete', `User deleted with email ${user.email}`);
    await user.destroy();
