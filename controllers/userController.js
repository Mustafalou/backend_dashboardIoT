...
exports.getUsers = async (req, res) => {
  try {
    const users = await User.findAll(); // il trouve les users dans la base de données
...
exports.deleteUser = async (req, res) => {
  try {
    ...
    res.status(500).send({ message: "Internal server error" }); // sino  envoie message error
  }
};
//ici ca recupere tous les logues d'acrivités
